...
public class IconArrayAdapter extends ArrayAdapter <String> {
	private final Context context;
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    TextView textView = (TextView) rowView.findViewById(R.id.spinner_text_new_category);
	    ImageView imageView = (ImageView) rowView.findViewById(R.id.spinner_icon_new_category);
	    textView.setText(values[position]);
	    // Change the icon for Windows and iPhone
	    String s = values[position];
	    imageView.setImageResource(R.drawable.icon_angry_minion);
