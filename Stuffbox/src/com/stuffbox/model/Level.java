...
public class Level {
	...
	private static final int badgeMark2 = 2; //Limit damit Badge 2 verliehen wird
	private static final int badgeMark3 = 3; //Limit damit Badge 3 verliehen wird
	private static final int badgeMark4 = 4; //Limit damit Badge 4 verliehen wird
	private static final int badgeMark5 = 6; //Limit damit Badge 5 verliehen wird
